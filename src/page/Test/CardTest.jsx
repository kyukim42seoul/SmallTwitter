...
export const Empty = () => {
  ...
  return (
    <div style={{display:"flex", flexDirection:"column", height:"inherit", padding:"0 1.6em"}}>
      ...
      <div style={{display:"flex", justifyContent:"flex-end", gap:"1.6em", padding:"1.2em 0"}}>
        <button style={{height:"54px", width:"54px", borderRadius:"27px", backgroundColor:"#80ACEF"}} onClick={()=>{navigate("/write")}}><AiOutlinePlus size={"2em"} color="#FFF" /></button>
      </div>
      <footer style={{justifySelf:"flex-end", height:"5.4em", backgroundColor:"#D9D9D9"}}>
      </footer>
    </div>
    );
};

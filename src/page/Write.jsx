  ...
  return (
    ...
    >
      ...
      >
        <Button
          className="point"
          onClick={() => setIsOpenSeeRight(true)}
          width="3rem"
        >
          <AiOutlineEye size={"2em"} color="#FFF" />
        </Button>
        {isOpenSeeRight ? (
          <ButtonList
            itemList={["everyone", "friends", "private"]}
            isClosable={true}
            setIsOpen={setIsOpenSeeRight}
            setValue={setSeeRight}
          />
        ) : null}
        <Button onClick={() => setIsOpenCommentRight(true)}>
          <FaRegComments size={"2em"} color="#FFF" />
        </Button>
        {isOpenCommentRight ? (
          <ButtonList
            itemList={["everyone", "friends", "private"]}
            isClosable={true}
            setIsOpen={setIsOpenCommentRight}
            setValue={setCommentRight}
          />
        ) : null}
        <Button
          ...
          onClick={() => {
            console.log(
              `text: ${text} seeRight: ${seeRight} commentRight: ${commentRight}`,
            );
          }}
        >
